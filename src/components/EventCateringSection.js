  ...
  return (
    <section className="bg-[#2e8687] py-12 w-full">
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
        <h2 className="text-white text-[30px] font-simplifica font-semibold tracking-wide mb-4 uppercase">
          ...
          <div className="text-white text-2xl font-simplifica font-semibold mb-6">Order Online at Store Price</div>
