  ...
  return (
    <section className="bg-[#f4fafd] py-16">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <span className="border-t border-secondary mr-4" style={{ width: '10%' }}></span>
...
<span className="border-t border-secondary ml-4" style={{ width: '10%' }}></span>
          ...
          {articles.map((a, i) => (
            <div key={i} className="bg-secondary rounded shadow-lg flex flex-col overflow-hidden">
              ...
              <div className="flex-1 flex flex-col p-6">
                ...
                <p className="text-white font-simplifica text-lg text-[27px]  mb-6 text-center">{a.desc}</p>
